...
namespace customerSdmodule.Message
{
    public class Message
    {
        public void SendSms(string Subject, int firmid, int branchid, string documentid, int moduleid, string customerid, string sender, string to, string message, ModelContext db)
        {
            ...
            _notificationRequest.From = "MABEN SD";
            ...
            _notificationRequest.DocumentDetail.ModuleId = 4;
